 ...
 *    time   : 2019/03/30
 *    desc   : 在 BaseDialog 基础上加上 {@link BottomSheetDialog} 特性
 */
public class BaseBottomDialog extends BaseDialog
    ...
    private View wrapContentView(View view) {
        ...
        ViewCompat.setAccessibilityDelegate(contentLayout, new MyAccessibilityDelegate());
    ...
    private class MyBottomSheetCallback extends BottomSheetCallback {
